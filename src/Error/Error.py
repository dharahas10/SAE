...
class Error:
    ...
    def _post_init(self, config, info, train_data, test_data):
    ...
    def measure(self, config, info, train_data, test_data):
        ...
        with tf.Graph().as_default():
            ...
            test_shape = [self._batch_size, self._input_neurons]
            # Actual Train Input
            ...
            pretrain_layers_weights, Y_out = model.inference(self._input_neurons,X)
